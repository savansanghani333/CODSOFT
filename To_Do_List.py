...
def main():
    ...
    button_addTask = tk.Button(root, text="Add Task", command=addTask)
    button_addTask.pack(side=tk.LEFT, padx=5)

    button_deleteTask = tk.Button(root, text="Delete Task", command=deleteTask)
    button_deleteTask.pack(side=tk.LEFT, padx=5)

    button_editTask = tk.Button(root, text="Edit Task", command=editTask)
    button_editTask.pack(side=tk.LEFT, padx=5)
